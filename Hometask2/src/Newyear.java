	...
	public class Newyear implements Gift 
	{
		...
		public static void main(String args[])
		{
			 ...
			 for(int h=0;h<t;h++)
			 {
				...
				System.out.println("Enter the weight and price and quantity for all the sweets: ");
				...
				if(no_of_chocolates_type!=0)
				{
					System.out.println("Select for sorting chocolates\n 1.Price 2.Weight 3.Quantity");
					int op=sc.nextInt();
					Arrays.sort(choc,new Sortchocos(op));
			...
			System.out.println("Counting candies in gift");
			System.out.println("1.Count candies for a particular child.\n"
			...
			System.out.println("Total Weight of new year gifts is: "+totalweight);
			sc.close();
